...
Friend Module Helpers
    ...
    Public Function RoundRect(ByVal Rect1 As Rectangle, ByVal Rounding As Integer, Optional ByVal Style As RoundingStyle = RoundingStyle.All) As Drawing2D.GraphicsPath
        ...
        Select Case Style
            Case RoundingStyle.All
                GP.AddArc(New Rectangle(Rect1.X, Rect1.Y, AW, AW), -180, 90)
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Y, AW, AW), -90, 90)
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Height - AW + Rect1.Y, AW, AW), 0, 90)
                GP.AddArc(New Rectangle(Rect1.X, Rect1.Height - AW + Rect1.Y, AW, AW), 90, 90)
            Case RoundingStyle.Top
                GP.AddArc(New Rectangle(Rect1.X, Rect1.Y, AW, AW), -180, 90)
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Y, AW, AW), -90, 90)
                GP.AddLine(New Point(Rect1.X + Rect1.Width, Rect1.Y + Rect1.Height), New Point(Rect1.X, Rect1.Y + Rect1.Height))
            Case RoundingStyle.Bottom
                GP.AddLine(New Point(Rect1.X, Rect1.Y), New Point(Rect1.X + Rect1.Width, Rect1.Y))
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Height - AW + Rect1.Y, AW, AW), 0, 90)
                GP.AddArc(New Rectangle(Rect1.X, Rect1.Height - AW + Rect1.Y, AW, AW), 90, 90)
            Case RoundingStyle.Left
                GP.AddArc(New Rectangle(Rect1.X, Rect1.Y, AW, AW), -180, 90)
                GP.AddLine(New Point(Rect1.X + Rect1.Width, Rect1.Y), New Point(Rect1.X + Rect1.Width, Rect1.Y + Rect1.Height))
                GP.AddArc(New Rectangle(Rect1.X, Rect1.Height - AW + Rect1.Y, AW, AW), 90, 90)
            Case RoundingStyle.Right
                GP.AddLine(New Point(Rect1.X, Rect1.Y + Rect1.Height), New Point(Rect1.X, Rect1.Y))
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Y, AW, AW), -90, 90)
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Height - AW + Rect1.Y, AW, AW), 0, 90)
            Case RoundingStyle.TopRight
                GP.AddLine(New Point(Rect1.X, Rect1.Y + 1), New Point(Rect1.X, Rect1.Y))
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Y, AW, AW), -90, 90)
                GP.AddLine(New Point(Rect1.X + Rect1.Width, Rect1.Y + Rect1.Height - 1), New Point(Rect1.X + Rect1.Width, Rect1.Y + Rect1.Height))
                GP.AddLine(New Point(Rect1.X + 1, Rect1.Y + Rect1.Height), New Point(Rect1.X, Rect1.Y + Rect1.Height))
            Case RoundingStyle.BottomRight
                GP.AddLine(New Point(Rect1.X, Rect1.Y + 1), New Point(Rect1.X, Rect1.Y))
                GP.AddLine(New Point(Rect1.X + Rect1.Width - 1, Rect1.Y), New Point(Rect1.X + Rect1.Width, Rect1.Y))
                GP.AddArc(New Rectangle(Rect1.Width - AW + Rect1.X, Rect1.Height - AW + Rect1.Y, AW, AW), 0, 90)
                GP.AddLine(New Point(Rect1.X + 1, Rect1.Y + Rect1.Height), New Point(Rect1.X, Rect1.Y + Rect1.Height))
        End Select
            ...
            If String.IsNullOrEmpty(TabPages(I).Tag) Then
                ...
                If SelectedIndex = I Then
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#2B2F33")), TextColor As New SolidBrush(ColorFromHex("#BECCD9")), TextFont As New Font("Segoe UI semibold", 9)
                        G.FillRectangle(Background, New Rectangle(Rect1.X - 5, Rect1.Y + 1, Rect1.Width + 7, Rect1.Height))
                        G.DrawString(TabPages(I).Text, TextFont, TextColor, New Point(Rect1.X + 50 + (ItemSize.Height - 180), Rect1.Y + 12))
                    End Using
                ...
                If Not IsNothing(ImageList) Then
                    If Not TabPages(I).ImageIndex < 0 Then
                        G.DrawImage(ImageList.Images(TabPages(I).ImageIndex), New Rectangle(Rect1.X + 25 + (ItemSize.Height - 180), Rect1.Y + ((Rect1.Height / 2) - 9), 16, 16))
                    End If
                End If
            ...
            Else
                ...
                Using TextColor As New SolidBrush(ColorFromHex("#6A7279")), TextFont As New Font("Segoe UI", 7, FontStyle.Bold), Border As New Pen(ColorFromHex("#2B2F33"))
                    ...
                    If FirstHeaderBorder Then
                        G.DrawLine(Border, New Point(Rect1.X - 5, Rect1.Y + 1), New Point(Rect1.Width + 7, Rect1.Y + 1))
                    Else
                        If Not I = 0 Then
                            G.DrawLine(Border, New Point(Rect1.X - 5, Rect1.Y + 1), New Point(Rect1.Width + 7, Rect1.Y + 1))
                        End If
                    ...
                    G.DrawString(TabPages(I).Text.ToUpper, TextFont, TextColor, New Point(Rect1.X + 25 + (ItemSize.Height - 180), Rect1.Y + 16))
...
Public Class XylosNotice
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Background As New SolidBrush(ColorFromHex("#373737")), MainBorder As New Pen(ColorFromHex("#323232")), TextColor As New SolidBrush(ColorFromHex("#FFFFFF")), TextFont As New Font("Segoe UI", 9)
                ...
                Using ItemsFont As New Font("Segoe UI", 9), Border As New Pen(ColorFromHex("#D0D5D9"))
                    ...
                    If (e.State And DrawItemState.Selected) = DrawItemState.Selected Then
                        ...
                        Using ItemsColor As New SolidBrush(Color.White), Itembackground As New SolidBrush(ColorFromHex("#78B7E6"))
                            G.FillRectangle(Itembackground, Rect1)
                            G.DrawString(GetItemText(Items(e.Index)), New Font("Segoe UI", 9), Brushes.White, New Point(Rect1.X + 5, Rect1.Y + 1))
                        End Using

                    Else
                        Using ItemsColor As New SolidBrush(ColorFromHex("#7C858E"))
                            G.FillRectangle(Brushes.White, Rect1)
                            G.DrawString(GetItemText(Items(e.Index)), New Font("Segoe UI", 9), ItemsColor, New Point(Rect1.X + 5, Rect1.Y + 1))
                        End Using
